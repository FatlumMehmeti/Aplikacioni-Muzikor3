...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(view: View) {
        when (view.id) {
            R.id.v_blob_btn -> if (checkAudioPermission()) launchBlobActivity() else requestAudioPermission()
            R.id.v_blast_btn -> if (checkAudioPermission()) launchBlastActivity() else requestAudioPermission()
            R.id.v_wave_btn -> if (checkAudioPermission()) launchWaveActivity() else requestAudioPermission()
            R.id.v_bar_btn -> if (checkAudioPermission()) launchSpikyWaveActivity() else requestAudioPermission()
            R.id.v_stream_btn -> if (checkAudioPermission()) launchMusicStreamActivity() else requestAudioPermission()
            R.id.v_circle_line_btn -> if (checkAudioPermission()) {
                launchCircleLinectivity()
            } else requestAudioPermission()

            R.id.v_hifi_btn -> if (checkAudioPermission()) {
    ...
    private fun launchCircleLinectivity() {
